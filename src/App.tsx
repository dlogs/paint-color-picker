        ...
        >
          <Route
            ...
            element={
              allColors.length > 0 ? (
                <div
                  className={cn("bg-card rounded-xl border shadow-sm p-6", accentColor && "hidden")}
                >
          ...
          />
          <Route path="/settings" element={<Settings allColors={allColors} />} />
          <Route path="/palette/:paletteId" element={<PaletteDetail allColors={allColors} />} />
