    ...
    return (
        ...
        >
            <div className="w-full max-w-6xl space-y-8">
                ...
                <div className={cn("flex flex-row items-center gap-2 sm:gap-4 w-full relative z-40", textColor)}>
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                        ...
                        <div className="sm:hidden">
                            <Sheet>
                                ...
                                <SheetContent side="right" className={cn("w-[85vw] sm:w-[400px] overflow-y-auto", accentColor ? (isDarkAccent ? 'bg-black/95 border-white/20' : 'bg-white/95 border-black/10') : 'bg-background')}>
